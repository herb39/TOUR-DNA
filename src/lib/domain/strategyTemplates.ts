...
export const STRATEGY_TEMPLATES: StrategyTemplate[] = [
  {
    ...
    supportedGoals: ["GOAL_STAY_EXPANSION", "GOAL_SPEND_EXPANSION", "GOAL_STAY_SPEND_EXPANSION", "GOAL_LOCAL_ECONOMY"],
  ...
  },
  {
    ...
    supportedGoals: ["GOAL_STAY_EXPANSION", "GOAL_SPEND_EXPANSION", "GOAL_STAY_SPEND_EXPANSION", "GOAL_VISITOR_GROWTH"],
  ...
  },
  {
    id: "CULTURE_ARTS",
    name: "문화예술·전시 연계형",
    concept: "전시·공연·문화예술공간과 인근 식음·상권을 엮어 관람 체류와 지역 소비를 늘리는 코스",
    demandAxisWeights: { demand: 0.5, diversity: 0.5 },
    supplyAxisWeights: { diversity: 0.6, network: 0.4 },
    idealMonths: [1, 2, 3, 4, 5, 6, 9, 10, 11, 12],
    targetAgeGroups: ["AGE_20S", "AGE_30S", "AGE_40S", "AGE_50S"],
    targetCompanionTypes: ["COMPANION_COUPLE", "COMPANION_FRIENDS", "COMPANION_FAMILY"],
    supportedGoals: ["GOAL_BRAND_IMAGE", "GOAL_NEW_MARKET", "GOAL_STAY_EXPANSION", "GOAL_SPEND_EXPANSION", "GOAL_STAY_SPEND_EXPANSION"],
    preferredBudgetLevels: ["MID", "PREMIUM"],
    preferredTransport: ["PUBLIC_TRANSPORT", "MIXED", "PRIVATE_VEHICLE"],
    preferredGroupTypes: ["FIT", "SMALL_10_20", "MEDIUM_21_40"],
    requiresOvernight: false,
    poiCategories: ["ATTRACTION", "EXPERIENCE", "FOOD"],
    kpiTemplates: [
      { name: "전시·공연 참여율", method: "예약·티켓·현장 체크인 인원 / 코스 참여 인원" },
      { name: "문화예술 체류시간", method: "전시·공연 구간의 실제 체류시간 로그" },
      { name: "인근 소비 연계율", method: "문화예술 방문 전후 인근 음식·상권 이용 비중" },
    ],
    riskTemplates: [
      "전시·공연 회차와 잔여 좌석을 출발 전 확인",
      "시설 휴관일·대관일과 여행 일정 충돌",
      "예약·티켓 발권 및 입장 마감 시간 확인",
    ],
    targetDescriptionTemplate: "전시·공연 관람과 지역의 감각적인 식음·상권 경험을 함께 원하는 여행객",
    foreignReadinessAdjustment: -2,
    foreignReadinessNote: "작품·공연 해설과 예약 안내의 언어 지원 여부에 따라 외국인 이용 편의가 달라질 수 있음",
    coreProblem: "전시·공연이 개별 방문으로 끝나 인근 식음·상권과 연계된 체류 소비로 이어지지 않음",
    coreResource: "미술관·전시관·공연장과 인근 음식점·상권",
    stayStyle: "회차·관람시간을 중심으로 구성한 반나절~1일 문화 체험형",
    executionDifficulty: "MEDIUM",
    expectedEffect: "문화예술 콘텐츠의 체류시간 확대와 관람 전후 지역 소비 연계(정성적 기대)",
  },
  {
    id: "FESTIVAL_EVENT",
    name: "축제·이벤트 연계형",
    ...
    supportedGoals: ["GOAL_VISITOR_GROWTH", "GOAL_OFF_SEASON_ACTIVATION", "GOAL_VISITOR_DISTRIBUTION", "GOAL_SEASONALITY_BALANCE"],
    preferredBudgetLevels: ["LOW", "MID"],
  ...
  },
  {
    ...
    supportedGoals: ["GOAL_NEW_MARKET", "GOAL_STAY_EXPANSION", "GOAL_SPEND_EXPANSION", "GOAL_STAY_SPEND_EXPANSION"],
    preferredBudgetLevels: ["LOW", "MID"],
