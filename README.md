...
| 10. 문화예술(미술관/전시/공연/현대문화공간) | TourAPI `VE07`(전시시설) 구조 신호 재사용 가능성 우선 검토 | **부분 구현(2026-08-17 1차)** — `CULTURE_ARTS` 분류·`VE07` 구조 신호·ATTRACTION 우선순위와 기존 문화·역사 전략 가산을 반영. 전용 전략 템플릿·공연/전시 운영시간 검증은 후속 |
