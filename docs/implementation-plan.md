...
선택한 전략 테마가 자동 초안과 편집 결과에 실제로 반영되도록 핵심 테마 POI의 최소 비중, 후보 풀 점수, 일정에 POI를 추가한 뒤의 거리·테마·동선 재정렬을 한 흐름으로 강화한다. 기존의 좋은 후보 우선 추천은 기반으로 유지한다.
...
> P0 기획 입력 구조 고도화와 P1-1 축제 Anchor 후보 조회·선택, P1-2a·P1-2b·P1-2c는 완료됐다. 현재 바로 시작할 다음 작업은 **핵심 테마 슬롯과 후보 재정렬**이며, 이후 근거 기반 여행 조건 검증을 진행한다.
